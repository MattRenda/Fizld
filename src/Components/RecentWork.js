            ...
            <>
                ...
                <a
                        ...
                        <div className='shadow-card'>
                            <img style={{ width: '300px', height: 'auto',margin:'30px 10px' }} src={require('../imgs/CHAMP-logo-smaller.png')}
                                alt="CHAMP logo"
                            />
                        </div>
                    </a>
                    ...
                    <a
                        ...
                        <div className='shadow-card'>
                            <img style={{ width: 'auto', height: '200px',margin:'30px 10px' }} src={require('../imgs/AC_heating_logo.png')}
                                alt="ACHeatinglogo"
                            />
                        </div>
                    </a>
                    ...
                    <a
                        ...
                        <div >
                            <img style={{ width: 'auto', height: '200px',margin:'30px 10px' }} src={'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTJU4sLEQiNp9Z4dnSV3tjOO1ZU8xkDMX6juA&usqp=CAU'}
                                alt="Button"
                            />
                        </div>
                    </a>
