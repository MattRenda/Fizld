...
const Pricing = () => {    
    ...
    return (
        <div className=''>
            ...
            <div style={{backgroundColor: '#0a63963b'}}>
                ...
                <div  className='mt-5 mb-5'>
                    <div style={{display: 'flex',flexWrap:'wrap',justifyContent:'space-evenly', padding:'50px 20px' }}>
                        ...
                        <div style={{width:'300px',height:'410px', display: 'flex', alignItems:'center', flexDirection:'column',textAlign:'center', margin:'10px'}}>
                            <div style={{position:'relative',height:'330px', width:'290px',backgroundColor:'#0a639694',borderTopLeftRadius:'10px',borderTopRightRadius:'10px',padding:'30px'}}>
                                <h2 style={{fontSize: '250%', color: 'white',fontFamily:'Oswald'}}>Static Content</h2>
                            </div>
                            <div  style={{position:'relative',height:'350px', width:'290px',backgroundColor:'white',borderBottomLeftRadius:'10px',borderBottomRightRadius:'10px',padding:'30px'}}>
                                <div >
                        ...
                        <div style={{width:'300px',height:'410px', display: 'flex', alignItems:'center', flexDirection:'column',textAlign:'center', margin:'10px'}}>
                            ...
                            <div  style={{position:'relative',height:'330px', width:'290px',backgroundColor:'white',borderBottomLeftRadius:'10px',borderBottomRightRadius:'10px',padding:'30px'}}>
                                <div>
                                    <div style={{width: '200px',height:'90px', position: 'relative' }}>
                                        <ButtonGame />
                                    </div>
